...
const Performance = () => {
  ...
  return (
    <div className="font-sans bg-white">
      ...
      {/* Hero Header - Identical to Social */}
      <header 
      ...
      {/* Detailed Intro with Parallax - Identical to Social */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-screen">
            ...
            <div className="order-1 lg:order-2">
              <img
                src="https://mime.org.uk/wp-content/uploads/2025/03/data_training-1.png" // Replace with your actual image
                alt="Data-Driven Performance Marketing"
      ...
      {/* What We Deliver - Smart adaptive layout matching Social */}
      <section className="relative overflow-hidden py-14 md:py-10"
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-8 space-y-8 md:space-y-12">
          ...
          <div className="space-y-2 lg:space-y-4">
            {/* First Row */}
            <div className={`flex flex-col lg:flex-row divide-y-2 lg:divide-y-0 lg:divide-x-2 divide-white/20 ${itemsCount <= 3 ? 'lg:justify-center' : ''}`}>
            ...
            {/* Second Row - Only render if there are more than 3 items */}
            {secondRowCount > 0 && (
      ...
      {/* The Zentrix Edge - Simple style like Social */}
